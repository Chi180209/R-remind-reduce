...
public class FragmentFruitVegetable extends Fragment {
    ...
    public FragmentFruitVegetable() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.ingredient_fragment_fruit_vegetable,container,false);
        //recyclerview
        re = v.findViewById(R.id.fruit_vegetableView);
    ...
    private void getIngredient() {
        ...
        DatabaseReference db = reference.child(uid).child("ingredients").child("FruitVegetable");
...
//                    caculer finish day
    ...
    private void addNotification(Items items) {
        ...
        String uId = user.getUid();
        reference = FirebaseDatabase.getInstance().getReference("Users");
        DatabaseReference notifiDb = reference.child(uId).child("Notification").child("FruitVegetable");
        ...
        Toast.makeText(getActivity(), "FruitVegetable Notification setting...", Toast.LENGTH_LONG).show();
    }
    ...
    private void check (){
        ...
        //init reference database
        reference = FirebaseDatabase.getInstance().getReference("Users");
        DatabaseReference dbNoti = reference.child(uid).child("Notification").child("FruitVegetable");
