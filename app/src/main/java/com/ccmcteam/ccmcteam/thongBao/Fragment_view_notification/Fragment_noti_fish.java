 ...
 */
public class Fragment_noti_fish extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.noti_fish,container,false);
        recyclerView = v.findViewById(R.id.noti_fish_view);
    ...
    private void getNotification() {
        ...
        DatabaseReference db = reference.child(uid).child("Notification").child("Fish");
