 ...
 */
public class Fragment_noti_meat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.noti_meat,container,false);
        recyclerView = v.findViewById(R.id.noti_meat_view);
    ...
    private void getNotification() {
        ...
        DatabaseReference db = reference.child(uid).child("Notification").child("Meat");
