 ...
 */
public class Fragment_noti_drink extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.noti_drink,container,false);
        recyclerView = v.findViewById(R.id.noti_drink_view);
    ...
    private void getNotification() {
        ...
        DatabaseReference db = reference.child(uid).child("Notification").child("Drink");
