 ...
 */
public class Fragment_noti_vegetable extends Fragment {
    ...
    public Fragment_noti_vegetable() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.noti_vegetable,container,false);
        recyclerView = v.findViewById(R.id.noti_vegetable_view);
    ...
    private void getNotification() {
        ...
        DatabaseReference db = reference.child(uid).child("Notification").child("FruitVegetable");
